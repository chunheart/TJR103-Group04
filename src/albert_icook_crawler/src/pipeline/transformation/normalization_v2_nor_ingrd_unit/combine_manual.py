...
INGREDIENT_FILE_PATH = ROOT_DIR / "data" / "db_ingredients" / f"icook_recipe_{MANUAL_DATE}_recipe_ingredients_unitN.csv"
...
RESULT_FILE_PATH = ROOT_DIR / "data" / "db_ingredients" / "combine" /f"icook_recipe_{MANUAL_DATE}_recipe_ingredients_unitN_combine.csv"
